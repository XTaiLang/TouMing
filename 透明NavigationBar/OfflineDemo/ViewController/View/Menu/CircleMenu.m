...
-(void)selectButtonAtIndex:(NSInteger)_index{
    ...
    [selectedButton setLittleButtonHeighted:YES];
    UIImageView *imgView=[selectedButton getImg];
    imgView.center=selectedButton.center;
    if ([_delegate respondsToSelector:@selector(circleMenuSelected: maskView: superView:)]) {
        [_delegate circleMenuSelected:_index maskView:imgView superView:selectedButton];
    }
