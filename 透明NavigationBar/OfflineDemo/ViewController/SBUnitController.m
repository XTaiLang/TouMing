...
@interface SBUnitController ()<SBUnitContainerViewDelegate,UINavigationControllerDelegate>
...
- ( id <UIViewControllerAnimatedTransitioning>)navigationController:(UINavigationController *)navigationController animationControllerForOperation:(UINavigationControllerOperation)operation fromViewController:(UIViewController *)fromVC toViewController:(UIViewController *)toVC{
    SBTransitionAnimator *animator;
    if ([fromVC isKindOfClass:[SBLessonController class]] && [toVC isKindOfClass:[SBMenuViewController class]] ) {
        animator=[SBTransitionAnimator CreateAnimatorWithType:Transition_Animator_Scale];
        return animator;
    }
    
    if ([fromVC isKindOfClass:[SBMenuViewController class]] && [toVC isKindOfClass:[SBLessonController class]]) {
        animator=[SBTransitionAnimator CreateAnimatorWithType:Transition_Animator_ScaleBack];
        return animator;
    }
    
    if ([fromVC isKindOfClass:[SBMenuViewController class]] && ![toVC isKindOfClass:[SBLessonController class]]) {
        animator=[SBTransitionAnimator CreateAnimatorWithType:Transition_Animator_MenuIn];
        return animator;
    }
